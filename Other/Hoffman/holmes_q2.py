...
Expression('x_n', g*(x_obs**n/(1+x_obs**n)))
...
Rule('synth_x2_obs', None >> X(), b)

Rule('synth_y_obs', Y() >> None, d)
...
L1 = sim1.run(param_values={'n':1})
L2 = sim2.run(param_values={'n': 2})
L3 = sim3.run(param_values={'n': 3})
L4 = sim4.run(param_values={'n': 4})


# plt.figure(figsize = (15,10))
# plt.subplot(231)
plt.figure()
plt.plot(L1.observables['x_obs'], L1.observables['y_obs'], label = 'x1y2', )
plt.plot(L2.observables['x_obs'], L2.observables['y_obs'], label = 'x3y2.5')
plt.plot(L3.observables['x_obs'], L3.observables['y_obs'], label = 'x2.3y3')
plt.plot(L4.observables['x_obs'], L4.observables['y_obs'], label = 'x1.7y20')
