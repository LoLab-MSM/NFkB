...
Rule('YSC_LR_binding',
     YSC(lr=None) + L_ex(r_in=1) % R_in(l_ex=1, ysc=None) <> YSC(lr=2) % L_ex(r_in=1) % R_in(l_ex=1, ysc=2), kLRYSCf,
     kLRYSCr)
Rule('ICD_formation',
     YSC(lr=2) % L_ex(r_in=1) % R_in(l_ex=1, ysc=2) >> ICD(csl=None, l='cyto') + YSC(lr=None) + Endo_on() + Endo_off(),
     kYSCICD)
...
Rule('gHes1_binds_ICDCSL', gHes1(ic=None) + CSL(icd=None, gh=None) <> gHes1(ic=1)%CSL(icd=None,gh=1), kgICf, kgICr)
Rule('gHes1_IC_complex_to_mRNA_Hes1', gHes1(ic=None,ph=None)>> mHes1(l='nuc') + gHes1(ic=None,ph=None), ktrcxn)
...
Rule('geneSlug_binds_ICDCSL', gSlug(ic=None) + CSL(icd=None, gsl=None) <> gSlug(ic=1)%CSL(icd=None,gsl=1),kICDCSLSlugf,kICDCSLSlugr)
Rule('gSlug_ICDCSL_complex_forms_mRNA', gSlug(ic=None) >> gSlug(ic=None) + mSlug(l='nuc'), ktrcxn)
...
Rule('gLinNgn2complex_to_mRNA', gL_in(n2=None) >> gL_in(n2=None) + mL_in(l='nuc'), ktrcxn)
