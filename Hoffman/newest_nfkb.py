...
Parameter('cIAP_0', 0.033) #10000 #8e-4
...
# Rule('IKKKi_IKKKa', NEMO(brip=None, state = 'I') <> NEMO(brip=None, state = 'A'), IKKKi_f_IKKK, IKKKa_r_IKKK)
...
# Expression('flipl_NFkBn', A20n*(NFkBn_free)**(newhill))
...
Observable('NEMO_obs', NEMO(brip = None, state = 'A'))
...
# print('nfkbn1')
# print(L1.observables['NFkBn_obs'])
# print('nfkbn2')
# print(L2.observables['NFkBn_obs'])
# print('nfkbn3')
...
# plt.figure()
plt.subplot(232)
plt.plot(tspan/60, L1.observables['obs_A20t'],label = 'A20t.1')
plt.plot(tspan/60, L2.observables['obs_A20t'],label = 'A20t1')
plt.plot(tspan/60, L3.observables['obs_A20t'],label = 'A20t10')
plt.plot(tspan/60, L4.observables['obs_A20t'],label = 'A20t100')
...
plt.subplot(234)
plt.plot(tspan/60, L1.observables['NEMO_obs'],label = 'NEMO.1')
plt.plot(tspan/60, L2.observables['NEMO_obs'],label = 'NEMO1')
plt.plot(tspan/60, L3.observables['NEMO_obs'],label = 'NEMO10')
plt.plot(tspan/60, L4.observables['NEMO_obs'],label = 'NEMO100')
