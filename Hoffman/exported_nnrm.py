...
Parameter('IkBat_0', 10000) #IkBa .002
Initial(IkBa_mRNA(), IkBat_0)
Parameter('IkBbt_0', 13000) #IkBa .0033
Initial(IkBb_mRNA(), IkBbt_0)
Parameter('IkBet_0', 7000) #IkBa .0003
...
Parameter('e_dn', 0.18)
Parameter('d_dn', 0.0014)
Rule('ad_c', IkBa(ikk=None, nfkb=None, loc='N', state='active') >> None, a_dc)
Rule('bd_c', IkBb(ikk=None, nfkb=None, loc='N', state='active') >> None, b_dc)
Rule('ed_c', IkBe(ikk=None, nfkb=None, loc='N', state='active') >> None, e_dc)
Rule('dd_c', IkBd(ikk=None, nfkb=None, loc='N', state='active') >> None, d_dc)
...
Rule('a_c_deg', IkBa(ikk=None, nfkb=None, loc='C', state='active') >> None, a_f_deg)
Rule('b_c_deg', IkBb(ikk=None, nfkb=None, loc='C', state='active') >> None, b_f_deg)
Rule('e_c_deg', IkBe(ikk=None, nfkb=None, loc='C', state='active') >> None, e_f_deg)
Rule('d_c_deg', IkBd(ikk=None, nfkb=None, loc='C', state='active') >> None, d_f_deg)

Rule('an_c_n', IkBa(ikk=None, nfkb=1, loc='C', state='active') % NFkB(ikb=1, loc='C') >> NFkB(ikb=None, loc='C'), and_c_n)
Rule('bn_c_n', IkBb(ikk=None, nfkb=1, loc='C', state='active') % NFkB(ikb=1, loc='C') >> NFkB(ikb=None, loc='C'), bnd_c_n)
Rule('en_c_n', IkBe(ikk=None, nfkb=1, loc='C', state='active') % NFkB(ikb=1, loc='C') >> NFkB(ikb=None, loc='C'), end_c_n)
