...
Parameter('VappCM1', 100)
Parameter('VappCM2', 100)
Parameter('VCyto1', 400)
Parameter('VCyto2', 400)
Parameter('VappNM1', 40)
Parameter('VappNM2', 40)
Parameter('VNuc1', 50)
Parameter('VNuc2', 50)

Compartment('ECM', None, 3, VolECM)
Compartment('CellMem1',ECM, 2, VappCM1)
Compartment('CellMem2',ECM, 2, VappCM2)
Compartment('Cyto1',CellMem1,3,VCyto1)
Compartment('Cyto2',CellMem2,3,VCyto2)
Compartment('NM1',Cyto1, 2, VappNM1)
Compartment('NM2',Cyto2,2,VappNM2)
...
# Initial(R_ICD(csl=None,r_tm=None)**Cyto1, ICD_0)
# Initial(R_ICD(csl=None,r_tm=None)**Cyto2, ICD_0)
...
#Ligand of 1 cell binds receptor of the other
...
# Rule('ICD_YSC', YSC(lr=None) + R_ICD(csl=None,r_tm=None) <> R_ICD(csl=None,r_tm=1) % YSC(lr=1), kLRf, kLRr)

# Rule('ICD_formation_1', R_ICD(csl=None,r_tm=ANY)**Cyto1 % YSC(lr=ANY)**CellMem1 >> R_ICD(csl=None,r_tm=None)**Cyto1 + YSC(lr=None)**CellMem1 + L_endo()**Cyto1, kYSCICD)
# Rule('ICD_formation_2', R_ICD(csl=None,r_tm=ANY)**Cyto2 % YSC(lr=ANY)**CellMem2 >> R_ICD(csl=None,r_tm=None)**Cyto2 + YSC(lr=None)**CellMem2 + L_endo()**Cyto2, kYSCICD)


# Activation of CSL

Parameter('kICD_c_n', 1e-1)
Parameter('kICDCSLf', 1e-4) #1e-2
...
Rule('mHes1_synth_1', None >> mHes1()**Cyto1, ktrcxn)
Rule('mHes1_synth_2', None >> mHes1()**Cyto2, ktrlxn)
...
#
# Rule('L_recycle_1', L_endo()**Cyto1 >> L(r=None,loc='cell_1'),krL)
# Rule('L_recycle_2', L_endo()**Cyto2 >> L(r=None,loc='cell_2'),krL)
...
plt.plot(tspan/60, sim_result.observables['prot_Hes1_1'], label='Hes1 Cell 1')
plt.plot(tspan/60, sim_result.observables['prot_Hes1_2'], label='Hes1 Cell 2')
plt.xlabel("Time (in min)", fontsize=10)
plt.ylabel("Molecules per Cell", fontsize=10)
plt.legend(loc=0)
